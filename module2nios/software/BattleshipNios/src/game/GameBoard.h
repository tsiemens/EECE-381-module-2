...
#define GAMEBOARD_LEFT_PADDING ((SCREEN_WIDTH/2)-(GAMEBOARD_COL_WIDTH*GAMEBOARD_LENGTH/2)+20) //Set to exactly half the screen
#define GAMEBOARD_LENGTH 10

#define GAMEBOARD_TOP_PADDING GAMEBOARD_COL_HEIGHT/2
#define GAMEBOARD_LEFT_PADDING2 ((SCREEN_WIDTH/2)-(GAMEBOARD_COL_WIDTH*GAMEBOARD_LENGTH/2))
#define GAMEBOARD_LEFT_CHAR_PADDING (PIXEL_TO_CHAR_WIDTH*(GAMEBOARD_LEFT_PADDING2+GAMEBOARD_COL_WIDTH))
